...
type Client interface {
	...
	Start(ctx context.Context, containerID, checkpointDir string, openTcp, terminal, fileLocks, withStdin bool, attachStdio StdioCallback) (pid int, err error)
	...
	CreateCheckpoint(ctx context.Context, containerID, checkpointDir, parentPath, criuPageServer string, exit, openTcp, unixSockets, terminal, fileLocks bool) error
}
